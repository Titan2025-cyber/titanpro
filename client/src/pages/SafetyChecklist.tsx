...
import { ShieldCheck, ShieldAlert, Plus, CheckCircle, XCircle, AlertTriangle, User } from "lucide-react";
              ...
              <Card key={cl.id} className={`border-l-4 ${cl.overallPass ? "border-green-500" : "border-[hsl(var(--titan-red))]"}`}>
                <CardContent className="p-3">
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <Badge className={`text-xs shrink-0 ${cl.overallPass ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}`}>
